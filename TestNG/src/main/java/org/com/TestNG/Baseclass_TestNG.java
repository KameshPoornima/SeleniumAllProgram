	...
	public static WebDriver BroswerLanch(String broswername) {
		try {
			if (broswername.equalsIgnoreCase("chrome")) {
				System.getProperty("webdriver.chrome.driver", "D:\\Selenium\\Prog\\TestNG\\Driver\\chromedriver.exe");
			 driver = new ChromeDriver();
				
			}else if (broswername.equalsIgnoreCase("Firefox")) {
				System.getProperty("webdriver.geckod.driver", "D:\\Selenium\\Prog\\TestNG\\Driver\\geckodriver.exe");
				 driver = new FirefoxDriver();
				
			}
			else if (broswername.equalsIgnoreCase("edge")) {
				System.getProperty("webdriver.edge.driver","D:\\Selenium\\Prog\\TestNG\\Driver\\msedgedriver.exe");
